...
class TestRenderPendulumFrame:
    ...
    def test_frame_shape_default(self, hanging_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame = render_pendulum_frame(hanging_state, config)
    ...
    def test_different_states_produce_different_frames(
        ...
        frame1 = render_pendulum_frame(hanging_state, config)
        frame2 = render_pendulum_frame(upright_state, config)
    ...
    def test_custom_length(self, tilted_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame_short = render_pendulum_frame(tilted_state, config, length=0.5)
        frame_long = render_pendulum_frame(tilted_state, config, length=2.0)
    ...
    def test_custom_figsize_and_dpi(self, hanging_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame_small = render_pendulum_frame(hanging_state, config, figsize=(3, 3), dpi=50)
        frame_large = render_pendulum_frame(hanging_state, config, figsize=(6, 6), dpi=150)
        # Both should render successfully
    ...
    def test_tilted_state_renders(self, tilted_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame = render_pendulum_frame(tilted_state, config)
    ...
    def test_negative_angle_renders(self, config: ControlTaskConfig):
        ...
        frame = render_pendulum_frame(state, config)
    ...
    def test_multiple_sequential_renders(
        ...
        frame1 = render_pendulum_frame(hanging_state, config)
        frame2 = render_pendulum_frame(tilted_state, config)
        frame3 = render_pendulum_frame(hanging_state, config)

...
class TestRenderCartPoleFrame:
    ...
    def test_frame_shape_default(self, upright_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame = render_cartpole_frame(upright_state, config)
    ...
    def test_different_states_produce_different_frames(
        ...
        frame1 = render_cartpole_frame(upright_state, config)
        frame2 = render_cartpole_frame(tilted_state, config)
    ...
    def test_custom_pole_length(self, upright_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame_short = render_cartpole_frame(upright_state, config, pole_length=0.5)
        frame_long = render_cartpole_frame(upright_state, config, pole_length=2.0)
    ...
    def test_custom_cart_dimensions(self, upright_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame = render_cartpole_frame(upright_state, config, cart_width=1.0, cart_height=0.5)
    ...
    def test_custom_figsize_and_dpi(self, upright_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame_small = render_cartpole_frame(upright_state, config, figsize=(4, 3), dpi=50)
        frame_large = render_cartpole_frame(upright_state, config, figsize=(8, 6), dpi=150)
        # Both should render successfully
    ...
    def test_extreme_state_renders(self, extreme_state: ControlTaskState, config: ControlTaskConfig):
        ...
        frame = render_cartpole_frame(extreme_state, config)
    ...
    def test_negative_position_renders(self, config: ControlTaskConfig):
        ...
        frame = render_cartpole_frame(state, config)
    ...
    def test_multiple_sequential_renders(
        ...
        frame1 = render_cartpole_frame(upright_state, config)
        frame2 = render_cartpole_frame(tilted_state, config)
        frame3 = render_cartpole_frame(upright_state, config)

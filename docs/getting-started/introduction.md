...
Our goal is to provide the scientific community with the tools to run in-silico simulations and experiments that accelerate discovery in the physical lab. For this reason, we try to embrace the messy reality of the lab by prioritizing:
